...
name = "yisrael"
mission_code = 153
distance_to_target = 0.950
is_mission_active = False
print(name ,mission_code,distance_to_target,is_mission_active)
print(type(name))
...
print(time_of_mission)


distance_in_miles = (int(input("how much km"))*0.62)
print(distance_in_miles)

new_agent_name = (input("what is your name"))
print(new_agent_name,name)
